                ...
                synchronized (cashboxes) {
                    ...
                    while (true) {
                        ...
                        if (!cashboxes.isEmpty()) {
                            ...
                            /**
                             * Пока поток засыпает на определенное время, он все также занимает монитор (sleep), а это нне совсем правильно,
                             * т.к. мы захватываем монитор всех касс, а используем только одну кассу.
                             * Таким образом, мы должны освободить монитор всех наших каасс, пока мы обслуживаемся только в одном кассе.
                             ...
                             * но только во время нашего ожидания в на 5мс и после того, как мы подождаи 5мс, мы опять должны захватить монитор,
